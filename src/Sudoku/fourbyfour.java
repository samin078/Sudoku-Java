...
public class fourbyfour  implements ActionListener,MouseListener{
    int number = 4;
    int chkcount=3;
    static int chkhint;
    static int k;
    ...
    public fourbyfour(int hint, int unknown, int level) {
        ...
        panel2.setBounds(800, 350, 250, 190);
        ...
        timeLabel.setBounds(800, 200, 250, 100);
